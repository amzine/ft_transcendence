...
import { getLeaderBoard } from './userquery';
    ...
    return (
        <div className="w-full h-full relative">
            <div className="background">
                <div className="leardboard-logo w-full max-w-full">
                    <b className="max-[700px]:!text-6xl">L<span>ea</span>d<span>e</span><span>r</span>  </b>
                    <b className="max-[700px]:!text-6xl">B<span>oa</span>r<span>d</span></b>
                </div>
                <div className="block"/>
                {
                    data == null || data.length === 0 ?
                    <div className="leardboard-logo max-w-full" style={{height: "60px"}}>
                        <b className="max-[700px]:!text-6xl" style={{font: "500 65px \"Clip\""}}><span>N</span>o   </b>
                        <b className="max-[700px]:!text-6xl" style={{font: "500 65px \"Clip\""}}>G<span>am</span><span>e</span>  </b>
                        <b className="max-[700px]:!text-6xl" style={{font: "500 65px \"Clip\""}}>Re<span>co</span>r<span>d</span>     </b>
                        <b className="max-[700px]:!text-6xl" style={{font: "500 65px \"Clip\""}}><span>Y</span>e<span>t</span></b>
                    </div>
                    :
                    <div className="leaderboard relative max-[800px]:!p-4 max-w-full">
                        <div className="list !w-full max-w-full m-0">
                            {
...
function OneRow({rank, id, username, winRate, gamesWon, gamesLost, gamesPlayed, head}
    : { rank: number,
        ...
        switch(rank) {
            case 1:
                ...
                onClick = {
                    ...
                    <div className="top-avatar"
                        style={{backgroundImage: `url("${process.env.REACT_APP_PUBLIC_URL ? process.env.REACT_APP_PUBLIC_URL : "http://localhost:5000"+"/profile-image/"+username}")`,
                        backgroundSize: "cover",
                        backgroundPosition: "center"}}/>
                    <div className="top-info">
                        <div className="top-username"><h1 className="h1">{username}</h1></div>
                        <BadgeReward rank={rank}/>
                        <div className="top-record"></div>
                    </div>
                </div>
                );
            case 2:
            ...
            default:
                return (
                    <div className={"element "+ ((rank === 4) ? (window.innerWidth > 900) ? "!mt-[450px]" : "" : "")}
                    onClick = {
                        () => navigate("/profile/" + username)}>
                        ...
                        <div className="user">
                            {!head ? 
                                <div className="avatar"
                                    ...
                                    backgroundSize: "cover",
                                    backgroundPosition: "center"}}/> : <></>}
                            <div className="username"><h1 className="h3">{username}</h1></div>
                        </div>
                    </div>
                )
        }
